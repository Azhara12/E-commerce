...
const LoginSignUp = () => {
  ...
  const { error, loading, isAuthenticate, token, user } = useSelector(
    (state) => state.user,
  );
  ...
  const [avatarPreview, setAvatarPreview] = useState(
    "http://www.pngall.com/wp-content/uploads/5/Profile.png",
  );
  ...
  }, [dispatch, error, alert, isAuthenticate, navigate, redirect, token, user]);
      ...
      {loading ? (
        ...
        <div className="login-register-container">
          <form
            ...
            onSubmit={currState === "Login" ? loginSubmit : registerSubmit}
          >
            ...
            <div className="terms-condition-text">
              ...
              {currState === "Login" ? (
                <p>
                  ...
                  <span onClick={() => setCurState("Register")}>
                    Click here
                  </span>
                </p>
              ) : (
